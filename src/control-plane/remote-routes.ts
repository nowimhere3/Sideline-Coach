...
export const DAEMON_ROUTE_POLICIES: readonly RoutePolicy[] = [
  ...
  { methods: ['POST'], path: '/api/games/files/check', access: 'local-only' },
  { methods: ['GET'], path: '/api/games/files/search', access: 'remote-read' },
  { methods: ['POST'], path: '/api/games/files/absolute-path', access: 'local-only' },
  ...
  { methods: ['POST'], path: /^\/api\/game\/(?:add|archive|restore)$/, access: 'local-only' },
  { methods: ['GET'], path: '/api/games/archived', access: 'local-only' },
  ...
  { methods: ['GET'], path: '/api/scout/formation-receivers', access: 'local-only' },
  { methods: ['POST'], path: '/api/scout/formation-run', access: 'local-only' },
